  ...
  fluidPage(
    ...
    fluidRow(
      column(
        ...
        tags$p("Cette page permet d'exposer ...)."),
        tags$hr(),
        ...
        tags$div(style="background:#f0f0f0; padding:10px;",
                 ...
                 hidden(div(id = ns("details1"),
                            ...
                            tags$ul(
                              ...
                              tags$a("Lien vers TP4", href="https://github.com/Abson-dev/Statistique-Exploratoire-Spatiale/TP4", target="_blank")
                            ),
                            tags$ul(
                              ...
                              tags$a("Malaria Atlas Project | Home", href="https://www.map.ox.ac.uk/", target="_blank")
                            ),
                 )
                 )
        ),
        ...
        tags$div(style="background:#f0f0f0; padding:10px;",
                 ...
                 hidden(div(id = ns("details2"),
                            ...
                            tags$ul(
                              ...
                              tags$a("Lien vers TP4", href="Statistique-Exploratoire-Spatiale/TP5 at main · Abson-dev/Statistique-Exploratoire-Spatiale", target="_blank")
                            ),
                            tags$ul(
                              tags$li("En savoir plus"),
                              ...
                              tags$a("Malaria Journal - Estimated distribution of malaria cases among children.", href="Malaria Journal - Estimated distribution of malaria cases among children.", target="_blank"),
        ...
        tags$div(style="background:#f0f0f0; padding:10px;",
                 ...
                 hidden(div(id = ns("details3"),
                            ...
                            tags$ul(
                              ...
                              tags$a("Lien vers TP6", href="Statistique-Exploratoire-Spatiale/TP6 at main · Abson-dev/Statistique-Exploratoire-Spatiale", target="_blank")
                            ),
                            tags$ul(
                              tags$li("En savoir plus"),
                              tags$p("« Bringing clarity to crisis », à la découverte de ACLED : une référence mondiale sur les conflits et la violence politique."),
                              ...
                              tags$a("ACLED (Armed Conflict Location and Event Data)", href="ACLED (Armed Conflict Location and Event Data)", target="_blank")
                            ),
                 )
                 )
        ),        
        ...
        tags$div(style="background:#f0f0f0; padding:10px;",
                 ...
                 hidden(div(id = ns("details4"),
                            ...
                            tags$ul(
                              tags$li("Derrière les chiffres : comment calculer cet indicateur ?"),
                              tags$p("Pour une compréhension de la méthodologie de calcul, vous pouvez consulter le TP4 du projet 'Statistique-Exploratoire-Spatiale' disponible sur GitHub avec 4 logiciels GEE with Python, GEE with JavaScript, R, Python :"),
                              tags$a("Lien vers TP11", href="Statistique-Exploratoire-Spatiale/TP10 at main · Abson-dev/Statistique-Exploratoire-Spatiale", target="_blank")
                            ),
                            tags$ul(
                              tags$li("En savoir plus"),
                              ...
                              tags$a("NDVI (indice de végétation par différence normalisée) et PRI (indice de réflectance photochimique) - Le guide complet du chercheur - METER Group.", href="NDVI (indice de végétation par différence normalisée) et PRI (indice de réflectance photochimique) - Le guide complet du chercheur - METER Group.", target="_blank"),
                            ),
                 )
                 )
        ),
        # Section 5 - NDMI
        tags$div(style="background:#f0f0f0; padding:10px;",
                 actionButton(ns("btn5"), label = "NDMI (Normalized Difference Moisture Index)", class = "btn-primary"),
                 hidden(div(id = ns("details5"),
                            tags$p("Le NDMI évalue le contenu en eau de la végétation, en particulier pour surveiller la sécheresse..."))))
      )
    )
  )
}
